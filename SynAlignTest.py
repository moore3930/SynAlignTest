...
class SynAlign(Model):
    ...
    def load_data(self):
        ...
        batch = iter.get_next()
        self.source_sent, self.target_sent = tf.py_func(batch_process, [batch], [tf.int32, tf.int32])
    ...
    def run_epoch(self, sess, epoch, shuffle=True):
        ...
        while 1:
            ...
            # loss, _, s, t = sess.run([self.loss, self.train_op, self.source_sent, self.target_sent])
            # print(s)
            # print(t)
